...
- `Installed` page for reviewing installed liveries, previewing thumbnails, and uninstalling selected liveries.
...
```text
PMDG Livery Installer MSFS2024 Setup v0.1.5.exe
```
...
- `Installed` 页面：查看已安装涂装、预览缩略图，并卸载选中的涂装。
